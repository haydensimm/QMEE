...
conditons. Specifically, the data is a series of respiromerty experiments at each of the conditions where the 
...
differences in metabolic capicity between treatments because effective acclimation should compensate for the 
