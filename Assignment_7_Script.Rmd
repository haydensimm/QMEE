...
JD: There is no discussion of what makes this a “generalized” linear model, and I'm not seeing it. A model with the identity link and a gaussian response is not generalized. I like the coefficient plot, but I'm pretty surprised you're willing to look at it and say the signs are “interesting” and “align” with things. A key part of statistical philosophy imo is being willing to look at your results and say that you didn't see anything clearly in a given experiment. Also: don't immediately conclude that there was nothing to see, there are many other possibilities. Grade: 1.8/3
