...
```
This seems to do a good job at addressing the differences in variance across the predicted values. The residuals vs fitted does not look to fan to one end and the scale-location looks more horizontal. Therefore, I am going to proceed with the transformed model.
